...
const char *Title = "gl-320-glsl-precision";
const char *vs_shader_code("glsl-precision.vert");
const char *fs_shader_code("glsl-precision.frag");
GLuint program = 0, vao = 0, texture;
GLuint mvp_loc = 0;
GLuint uTransform_loc = 0, uMaterial_loc;
GLuint uboTransform, uboMaterial;
Shader precisionShader("glsl-precision");
...
{
	precisionShader.init();
	precisionShader.attach(GL_VERTEX_SHADER, vs_shader_code);
	precisionShader.attach(GL_FRAGMENT_SHADER, fs_shader_code);
	precisionShader.link();
	precisionShader.use();
	program = precisionShader.program; 
